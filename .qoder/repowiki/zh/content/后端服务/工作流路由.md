...
- [server/src/routes/agent.ts:1-1032](file://server/src/routes/agent.ts#L1-L1032)
...
**图表来源**
- [server/src/routes/agent.ts:794-837](file://server/src/routes/agent.ts#L794-L837)
- [server/src/routes/agent.ts:887-929](file://server/src/routes/agent.ts#L887-L929)
...
- **错误处理机制**
  ...
  - **新增**：批量变体执行失败：检查 intent.variants 数组格式和每个变体的配置
