...
- services：业务服务，封装 ComfyUI 的 HTTP/WebSocket 客户端与会话管理，**新增** ComfyUI Launcher 服务
...
## 结论
该后端服务以适配器模式组织工作流，结合 Express 的路由与中间件、ComfyUI 的 HTTP/WebSocket 能力以及本地会话持久化，形成一套完整的本地图像/视频批处理与实时反馈系统。**新增的 ComfyUI Launcher 服务显著提升了服务器启动的可靠性，通过自动检测、启动和健康检查机制，确保 ComfyUI 服务始终处于可用状态**。其模块化设计便于扩展更多工作流与功能，同时通过 WebSocket 事件桥接与输出下载优化提升了用户体验。
