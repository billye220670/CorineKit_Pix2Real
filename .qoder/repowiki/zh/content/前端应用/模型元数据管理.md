...
## 更新摘要
**变更内容**
- 新增超过1725行的模型元数据，显著扩展了可用模型选项特别是姿态类别
...
- **更新** 新增大量姿态类别条目，涵盖IL、PONY、光辉等多个系列的详细姿势模型
...
**更新** 本次更新显著扩展了模型目录数据，新增了超过1725行的模型元数据，涵盖了角色、姿态、表情、风格、滑块和多视角等多个详细分类系统，包括来自不同游戏系列（如原神、碧蓝档案、鸣潮、探灵直播、魔女的复仇之夜等）的专业模型。特别地，姿态类别得到了大幅扩展，包含超过1700个详细的姿势模型条目，涵盖IL、PONY、光辉等多个系列的完整模型目录。
...
**章节来源**
- [metadata.json:1-1770](file://model_meta/metadata.json#L1-L1770)
...
- [ModelSelect.tsx:1-1184](file://client/src/components/ModelSelect.tsx#L1-L1184)
...
**图表来源**
- [ModelSelect.tsx:37-1184](file://client/src/components/ModelSelect.tsx#L37-L1184)
...
- [ModelSelect.tsx:800-1184](file://client/src/components/ModelSelect.tsx#L800-L1184)
...
**更新** 特别值得注意的是，系统现在包含了超过1725行的模型元数据，其中姿态类别得到了大幅扩展，涵盖了IL、PONY、光辉等多个系列的详细姿势模型，为用户提供了更加丰富和专业的模型选择体验。这些新增的模型条目包括了来自不同游戏系列的专业模型，如原神、碧蓝档案、鸣潮、探灵直播、魔女的复仇之夜等，为用户提供了更加全面的模型选择范围。
