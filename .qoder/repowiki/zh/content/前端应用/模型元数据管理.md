...
## 更新摘要
**变更内容**
- metadata.json 新增260+行条目，显著扩展了模型元数据规模
- 新增大量姿态、角色、服装和性别类别条目，涵盖IL、PONY、光辉等多个系列
- 增强触发词管理和关键字系统，支持更精细的模型分类和检索
- 扩展AI Agent智能增强功能，提供更丰富的模型描述和标签
- 优化LoRA模型兼容性和推荐强度管理
...
**更新** 本次更新显著扩展了模型目录数据，新增了260+行的模型元数据，其中姿态类别得到了大幅扩展，涵盖了IL、PONY、光辉等多个系列的详细姿势模型。系统现在包含超过2000行的元数据条目，为用户提供了更加丰富和专业的模型选择体验。这些新增的模型条目包括了来自不同游戏系列的专业模型，如原神、碧蓝档案、鸣潮、探灵直播、魔女的复仇之夜等，为用户提供了更加全面的模型选择范围。
...
**章节来源**
- [metadata.json:1-2030](file://model_meta/metadata.json#L1-L2030)
...
- [ModelSelect.tsx:1-1295](file://client/src/components/ModelSelect.tsx#L1-L1295)
...
- [useModelMetadata.ts:204-254](file://client/src/hooks/useModelMetadata.ts#L204-L254)
...
已_loaded --> 缩略图删除中 : removeThumbnail
...
已_loaded --> 强度计算中 : getDefaultStrength
已加载 --> 缩略图上传中 : uploadThumbnail
已加载 --> 昵称设置中 : setNickname
已加载 --> 触发词设置中 : setTriggerWords
已加载 --> 触发词删除中 : deleteTriggerWords
...
**图表来源**
- [useModelMetadata.ts:8-254](file://client/src/hooks/useModelMetadata.ts#L8-L254)
...
**图表来源**
- [ModelSelect.tsx:37-1295](file://client/src/components/ModelSelect.tsx#L37-L1295)
...
- [ModelSelect.tsx:800-1295](file://client/src/components/ModelSelect.tsx#L800-L1295)
...
- [useModelMetadata.ts:120-160](file://client/src/hooks/useModelMetadata.ts#L120-L160)
...
- [useModelMetadata.ts:120-140](file://client/src/hooks/useModelMetadata.ts#L120-L140)
...
- [useModelMetadata.ts:162-200](file://client/src/hooks/useModelMetadata.ts#L162-L200)
...
**更新** 特别值得注意的是，系统现在包含了超过2000行的模型元数据，其中姿态类别得到了大幅扩展，涵盖了IL、PONY、光辉等多个系列的详细姿势模型，为用户提供了更加丰富和专业的模型选择体验。这些新增的模型条目包括了来自不同游戏系列的专业模型，如原神、碧蓝档案、鸣潮、探灵直播、魔女的复仇之夜等，为用户提供了更加全面的模型选择范围。
