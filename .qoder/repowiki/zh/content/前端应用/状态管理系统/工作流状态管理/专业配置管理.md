...
## 更新摘要
**变更内容**
- 更新了状态管理重构部分，反映 `faceSwapZones` 重命名为 `zitConfigs` 的变更
- 修正了配置数据存储结构，统一使用 `zitConfigs` 替代 `faceSwapZones`
- 更新了相关组件和方法的实现细节，确保与最新的代码保持一致
...
**更新** 本版本反映了状态管理重构：faceSwapZones 重命名为 zitConfigs，体现面部交换功能向 ZIT（Zero-shot Image Translation）配置的演进。
...
图表来源
- [Text2ImgSidebar.tsx:1-595](file://client/src/components/Text2ImgSidebar.tsx#L1-L595)
...
- [useWorkflowStore.ts:590-637](file://client/src/hooks/useWorkflowStore.ts#L590-L637)
...
图表来源
- [Text2ImgSidebar.tsx:116-164](file://client/src/components/Text2ImgSidebar.tsx#L116-L164)
- [ZITSidebar.tsx:120-169](file://client/src/components/ZITSidebar.tsx#L120-L169)
- [useWorkflowStore.ts:590-637](file://client/src/hooks/useWorkflowStore.ts#L590-L637)
- [sessionService.ts:105-115](file://client/src/services/sessionService.ts#L105-L115)
...
章节来源
- [sessionService.ts:4-13](file://client/src/services/sessionService.ts#L4-L13)
- [Text2ImgSidebar.tsx:119-130](file://client/src/components/Text2ImgSidebar.tsx#L119-L130)
...
章节来源
- [sessionService.ts:15-28](file://client/src/services/sessionService.ts#L15-L28)
- [ZITSidebar.tsx:123-136](file://client/src/components/ZITSidebar.tsx#L123-L136)
...
图表来源
- [useWorkflowStore.ts:590-613](file://client/src/hooks/useWorkflowStore.ts#L590-L613)
...
图表来源
- [useWorkflowStore.ts:615-637](file://client/src/hooks/useWorkflowStore.ts#L615-L637)
...
图表来源
- [useWorkflowStore.ts:592-598](file://client/src/hooks/useWorkflowStore.ts#L592-L598)
- [useWorkflowStore.ts:616-622](file://client/src/hooks/useWorkflowStore.ts#L616-L622)
...
**更新** 状态管理重构后，faceSwapZones 字段已重命名为 zitConfigs，用于统一管理 ZIT 配置数据。
...
章节来源
- [sessionService.ts:52-61](file://client/src/services/sessionService.ts#L52-L61)
- [sessionService.ts:105-115](file://client/src/services/sessionService.ts#L105-L115)
- [sessionManager.ts:101-163](file://server/src/services/sessionManager.ts#L101-L163)
...
- 添加文本到图像卡片
  ...
  - 参考路径：[Text2ImgSidebar.tsx:116-164](file://client/src/components/Text2ImgSidebar.tsx#L116-L164)，[useWorkflowStore.ts:590-613](file://client/src/hooks/useWorkflowStore.ts#L590-L613)

- 添加 ZIT 卡片
  - 步骤：在 ZIT 侧边栏选择 UNet/LoRA 模型，配置 Shift 偏移与采样参数，点击生成按钮。
  - 行为：组件构建 ZitConfig，调用 addZitCard 创建卡片，显示 base64 占位图，随后发起工作流执行请求。
  - 参考路径：[ZITSidebar.tsx:120-169](file://client/src/components/ZITSidebar.tsx#L120-L169)，[useWorkflowStore.ts:615-637](file://client/src/hooks/useWorkflowStore.ts#L615-L637)

- 管理配置参数
  - 本地草稿：Text2Img 与 ZIT 侧边栏分别使用 localStorage 键保存草稿，切换标签页不丢失参数。
  - 设置项：通过 useSettingsStore 管理逆向提示词模型与启动行为等全局设置。
  - 参考路径：[Text2ImgSidebar.tsx:92-95](file://client/src/components/Text2ImgSidebar.tsx#L92-L95)，[ZITSidebar.tsx:92-95](file://client/src/components/ZITSidebar.tsx#L92-L95)，[useSettingsStore.ts:16-30](file://client/src/hooks/useSettingsStore.ts#L16-L30)

- 提示词助手集成
  - 支持"自然语言→标签"、"标签→自然语言"、"按需扩写"等模式，通过系统提示词模板与后端接口交互。
  - 参考路径：[systemPrompts.ts:4-144](file://client/src/components/prompt-assistant/systemPrompts.ts#L4-L144)，[Text2ImgSidebar.tsx:166-187](file://client/src/components/Text2ImgSidebar.tsx#L166-L187)，[ZITSidebar.tsx:171-192](file://client/src/components/ZITSidebar.tsx#L171-L192)
...
- 配置优化建议
  ...
  - 参考路径：[Text2ImgSidebar.tsx:80-86](file://client/src/components/Text2ImgSidebar.tsx#L80-L86)，[ZITSidebar.tsx:80-86](file://client/src/components/ZITSidebar.tsx#L80-L86)
...
- 参考路径：[Text2ImgSidebar.tsx:86-87](file://client/src/components/Text2ImgSidebar.tsx#L86-L87)，[ZITSidebar.tsx:86-87](file://client/src/components/ZITSidebar.tsx#L86-L87)，[useSession.ts:397-418](file://client/src/hooks/useSession.ts#L397-L418)

## 故障排除指南
- 生成失败或无输出
  - 检查 clientId 是否存在，确保 WebSocket 连接正常。
  - 查看控制台错误信息，确认工作流执行接口返回状态。
  - 参考路径：[Text2ImgSidebar.tsx:117-160](file://client/src/components/Text2ImgSidebar.tsx#L117-L160)，[ZITSidebar.tsx:121-165](file://client/src/components/ZITSidebar.tsx#L121-L165)

- 卡片未显示或占位图缺失
  - 确认 addText2ImgCard/addZitCard 是否正确返回 imageId。
  - 检查 base64 PNG 生成逻辑与 Blob/File 创建过程。
  - 参考路径：[useWorkflowStore.ts:590-613](file://client/src/hooks/useWorkflowStore.ts#L590-L613)，[useWorkflowStore.ts:615-637](file://client/src/hooks/useWorkflowStore.ts#L615-L637)

- 会话保存失败
  - 检查 putSessionState 请求是否成功，确认服务端 sessionManager 写入权限。
  - 参考路径：[sessionService.ts:105-115](file://client/src/services/sessionService.ts#L105-L115)，[sessionManager.ts:103-110](file://server/src/services/sessionManager.ts#L103-L110)
...
章节来源
- [Text2ImgSidebar.tsx:117-160](file://client/src/components/Text2ImgSidebar.tsx#L117-L160)
- [ZITSidebar.tsx:121-165](file://client/src/components/ZITSidebar.tsx#L121-L165)
- [useWorkflowStore.ts:590-637](file://client/src/hooks/useWorkflowStore.ts#L590-L637)
- [sessionService.ts:105-115](file://client/src/services/sessionService.ts#L105-L115)
- [sessionManager.ts:103-110](file://server/src/services/sessionManager.ts#L103-L110)
- [systemPrompts.ts:4-144](file://client/src/components/prompt-assistant/systemPrompts.ts#L4-L144)
...
## 结论
本配置管理体系通过明确的配置结构、稳定的卡片创建机制与可靠的会话持久化，实现了从参数采集到结果渲染的完整闭环。Text2ImgConfig 与 ZitConfig 分别针对不同工作流场景提供精细化参数控制，配合 base64 占位符图片与本地草稿机制，既保证了用户体验，也提升了系统的健壮性。状态管理重构后，zitConfigs 字段统一管理 ZIT 配置数据，简化了状态结构并提高了代码的可维护性。建议在实际使用中遵循性能与稳定性原则，结合提示词助手与会话管理工具，持续优化生成质量与效率。
